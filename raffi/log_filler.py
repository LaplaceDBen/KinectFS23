...
for i in range(2000):
    ...
    newLine = f"QRCODE: Haus_B, (1,1),1 | QRCODE: Baum, (1569, 677), 87.22 | QRCODE: Haus_A, ({value1}, {value2}), {value3} | QRCODE: Haus_D, (1835, 1246), 87.12 | QRCODE: Haus_C, (1296, 1284), 89.24 | 2023-04-21 19:25:39.979248\n"
