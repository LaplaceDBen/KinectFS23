            ...
            if self.log_line_queue:
                ...
                for obj in objects:
                    if obj[0] == 'Haus_A':
                        ...
                        if obj1:
                            obj1.location.x = -house_A[0]*0.2
                            obj1.location.y = -house_A[1]*0.2
                        ...
                        if obj2:
                            obj2.location.x = -house_B[0]*0.2
                            obj2.location.y = -house_B[1]*0.2
                        ...
                        if obj3:
                            obj3.location.x = -house_C[0]*0.2
                            obj3.location.y = -house_C[1]*0.2
                        ...
                        if obj4:
                            obj4.location.x = -house_D[0]*0.2
                            obj4.location.y = -house_D[1]*0.2
                        ...
                        if obj5:
                            obj5.location.x = -tree[0]*0.2
                            obj5.location.y = -tree[1]*0.2
